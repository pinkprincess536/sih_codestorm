...
def extract_fields(image_path):
    ...
    try:
        ...
        if uni_start_idx != -1:
            ...
            # This is key to grabbing 'of Technology' when it is split into a third line
        ...
        if id_match:
            # We specifically look for the last matched value since Certificate ID is at the bottom right.
            # However, for simplicity and relying on the format, we use the first match.
...
if __name__ == "__main__":
    # 1. PLACE YOUR CERTIFICATE IMAGE IN THE SAME FOLDER as this script.
